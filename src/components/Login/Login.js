        ...
        <div className={styles.Login}>
            <div className={styles.modal}>
                ...
                <div className={styles.socialNetwork}>
                    <button className={styles.btn_socialNetwork} id='Google' name="Google" value="Google" onClick={handleGoogleLogin} >
                    ...
                    <button className={styles.btn_socialNetwork} value="GitHub" onClick={handleGitHubLogin} >
                ...
                <span>Chưa có tài khoản? <span className={styles.dangKy}>Đăng ký</span></span>
            </div>
        </div>
    )
}
