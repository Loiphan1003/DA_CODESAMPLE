      ...
      <div className={styles.couresDetail}>
        <div className={styles.couresDetailTitle}>
          <div className={styles.heading}>
            <h1>{nameTheory}</h1>
            <p>
              Hiểu sâu hơn về cách hoạt động, tìm hiểu về IIFE, closure,
              reference types, this keyword, bind, call, apply, prototype, ...
            </p>
          </div>
          <div className={styles.what_learn}>
            ...
            <ul className={styles.list_whatLearn}>
              ...
              <li>
                <FontAwesomeIcon icon={faCheck} />
                Hiểu được cách tư duy nâng cao của các lập trình viên có kinh
                nghiệm
              </li>
              <li>
                <FontAwesomeIcon icon={faCheck} />
              ...
              <li>
                <FontAwesomeIcon icon={faCheck} />
                Hiểu được các khái niệm khó về từ khóa, phương thức xử lý bất
                đồng bộ
              </li>
              <li>
                <FontAwesomeIcon icon={faCheck} />
                Nâng cao cơ hội thành công khi phỏng vấn xin việc nhờ kiến thức
          ...
          <ul className={styles.couresDetailList}>
            {coures.map((coure) => (
              <div style={{ width: "100%", display: "flex" }}>
                <NavLink
                  to={`/couredetail/section/${coure.id}`}
                  key={coure.id}
                  className={styles.coure}
                >
                  <LibraryBooksIcon />
                  {coure.tieuDe}
                </NavLink>
