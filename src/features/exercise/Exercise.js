...
function Exercise(props) {
    ...
    const handleAddListImport = () => {
        ...
        if (importCauHoiCode.length > 0) {
            ...
            dispatch(
                importDataSlice.actions.setCauHoiCode([])
            );
        }
        ...
        if (importCauHoiTracNghiem.length > 0) {
            ...
            dispatch(
                importDataSlice.actions.setCauHoiTracNghiem([])
            );
        }
            ...
            <div className={styles.container}>
                ...
                <div className={styles.TableCauHoiCode}>
                    <div>
                        ...
                        <ImportBTCode type={"BaiTapCode"} style={{ marginBottom: "20px", float: "right" }} />
                            ...
                            <TableBody>
                                {rowsTN.map((row) => (
                                    <TableRow
                                        ...
                                        sx={{ "&:last-child td, &:last-child th": { border: 0 } }}>
                                        <TableCell component="th" scope="row" >{row.idbaiTapTracNghiem}</TableCell>
                                        ...
                                        <TableCell align="center" >
                                            <ModeEditIcon sx={{ cursor: "pointer" }}
                                                onClick={() => handleOpenEditBTTN(row.idbaiTapTracNghiem, row.cauHoi, row.dapAn, row.cauTraLoi1, row.cauTraLoi2, row.cauTraLoi3, row.cauTraLoi4)}
                                            />
                                        </TableCell>
                                    </TableRow>
                                ))}
                ...
                <Dialog
                    open={importCauHoiTracNghiem.length > 0 || importCauHoiCode.length > 0}
                    fullWidth
                    maxWidth='xl'
                                ...
                                <TableHead>
                                    ...
                                    {importCauHoiTracNghiem.length > 0 &&
                                        ...
                                        <TableRow>
                                            ...
                                            <TableCell sx={{ width: '20%', fontWeight: "700" }} align="center">Câu hỏi</TableCell>
                                            <TableCell sx={{ width: '20%', fontWeight: "700" }} align="center">Đáp án 1</TableCell>
                                            <TableCell sx={{ width: '10%', fontWeight: "700" }}>Đáp án 2</TableCell>
                                            <TableCell sx={{ width: '10%', fontWeight: "700" }}>Đáp án 3</TableCell>
                                            <TableCell sx={{ width: '10%', fontWeight: "700" }}>Đáp án 4</TableCell>
                                            <TableCell sx={{ width: '10%', fontWeight: "700" }}>Đáp án đúng</TableCell>
