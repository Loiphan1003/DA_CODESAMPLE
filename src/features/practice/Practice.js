            ...
            <div className={styles.practice}>
                <div className={styles.conten_control}>
                    <div className={styles.conten_control_search}>
                        <input onChange={(e) => handleSearchText(e)} type="text" className={styles.control_search} placeholder="Tìm kiếm bài tập" />
                ...
                <ListPractice onClickPractice={handClickPractice}
